...
import SingelPaymentSummary from '../components/SingelPayment';
import SingleRegistration from '../components/SingelReg';
  ...
  useEffect(() => {
    ...
    class Particle {
      constructor() {
        ...
        // Updated to blue/pink color scheme to match team registration
    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 p-4 md:p-8">
        <div className="max-w-5xl mx-auto">
          {
            formdata !== null && !back ? 
              <SingelPaymentSummary formData={formdata} goback={goback} /> :
              <SingleRegistration setform={setformData} onsubmit={goToPayment} />
          }
        </div>
      </div>
    </div>
