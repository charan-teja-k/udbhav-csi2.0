                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      readOnly
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-[#203a43] focus:outline-none transition-all duration-300 bg-gray-100 cursor-not-allowed"
                    />
                  </div>
